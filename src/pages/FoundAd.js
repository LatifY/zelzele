...
export default function FoundAd() {
    ...
    const isValid = () => {
        ...
        if(finder.length > 20 || finder.length == 0 || finder == null){
            return false;
        }
    ...
    return (
        <>
            ...
            <div className="ad">
                <h1>
                    Bulunan Hayvan İlanı Ver{" "}
                    <span className="smallinfo">(* alanlar zorunludur)</span>
                </h1>

                <form onSubmit={handleSubmit}>
                    <label className="label" for="finder">
                        Adınız (*)
                    </label>
                    <input
                        required
